...
namespace DiaOito.Controllers
{
    ...
    public class EspecialidadesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Especialidade")] Especialidades especialidades)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Especialidade")] Especialidades especialidades)
        {
            if (ModelState.IsValid)
            {
